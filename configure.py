...
class Config:
    ...
    copyright = "Copyright © 2018—2020 Cyano Hao and Nowar Typeface. Portions Copyright 2011 Google Inc. Portions © 2014-2019 Adobe (http://www.adobe.com/), with Reserved Font Name 'Source'."
    ...
    fontPackRegion = ["Bliz", "Neut", "CL",
                      "PSimp", "PSimpChat", "GBK", "Big5"]
...
shsRegionMap = {
    ...
    "KR": "SourceHanSansK",
    "CL": "SourceHanSansK",
    "GBK": "SourceHanSansGBK",
    "Big5": "SourceHanSansBig5",
}
...
def LocalizedFamily(p):
    return {LanguageId.enUS: "War Sans"}
...
if __name__ == "__main__":
    ...
    for r, w, fea in product(config.fontPackRegion, config.fontPackWeight, powerset(config.fontPackFeature)):
        ...
        pack = "out/WarSansCFF-{}-${{VERSION}}.7z".format(target)
